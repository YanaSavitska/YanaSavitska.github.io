...
?>
        	<main>
	    <div class="pos_2">
	        <p><img id="largeImg" src="images/clothes/j4_1.jpg" alt="Large image" /></p>
                <p class="thumbs">
                    <a href="images/clothes/j4_1.jpg"><img src="images/clothes/j4_1.jpg" /></a>
                    <a href="images/clothes/j4_2.jpg"><img src="images/clothes/j4_2.jpg" /></a>
                    <a href="images/clothes/j4_4.jpg"><img src="images/clothes/j4_4.jpg" /></a>
                </p>
        </div>
        <div class="pos_2">
            ...
            <p class="en" lang="en"> Price: <input type="text" readonly id="en_j4" class="text"/> $ <br>
            ...
            <p class="uk" lang="uk"> Ціна: <input type="text" readonly id="uk_j4" class="text" /> грн. <br>
            ...
            <p class="ru" lang="ru"> Цена: <input type="text" readonly id="ru_j4" class="text" /> р. <br>
